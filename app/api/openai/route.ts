  ...
  const product = await prisma.product.findMany({
    ...
    const res = await openai.chat.completions.create({
      messages: [
        ...
        6. Format Link Product = https://www.riotgear.vercel.app/store/catalog/e7369d70-3380-4a18-8011-d2ba4d01ba9f *Note: ini hanya contoh
        ...
        10. Setiap barang yang sudah dibeli tidak bisa di return.
        11. Jika role user bertanya diluar konteks website riotgear, berikan jawaban tidak dapat memberitahukan informasi.
        `},
